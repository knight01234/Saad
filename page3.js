(function() {
  ...
  var CURVE = 0.25;
  var ENERGY = 0.02;
  var FALLING_CHANCE = 0.3; // Significantly increased chance for more frequent stars
  ...
  function redrawWorld() {
      ...
      if (!falling_star || (falling_star && falling_star.e < ENERGY)) {
          if (FALLING_CHANCE > Math.random()) {
